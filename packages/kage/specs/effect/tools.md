...
Practical reference for the current tool-migration state in `packages/kage`.
...
Tool tests should use the existing Effect helpers in `packages/kage/test/lib/effect.ts`:
