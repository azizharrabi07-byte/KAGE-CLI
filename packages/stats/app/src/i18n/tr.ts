export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | KAGE Data",
  "app.description":
    "KAGE Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde KAGE Data logosu",
  ...
  "header.githubAria": "GitHub'da KAGE'a yıldız ver",
  "header.github": "GitHub",
  "header.tryKAGE": "KAGE'u dene",
  ...
  "footer.homeAria": "KAGE ana sayfası",
  ...
  "home.topModelsDescription": "KAGE Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz KAGE Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | KAGE Data",
  "lab.description":
    "KAGE Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son KAGE kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "KAGE'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son KAGE kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük KAGE token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | KAGE Data",
  "model.description":
    "{{model}} için KAGE Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda KAGE Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki KAGE Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki KAGE Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde KAGE Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son KAGE Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz KAGE Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük KAGE Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz KAGE Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama KAGE Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan KAGE Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen KAGE Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son KAGE Go token hacmine göre yakındaki modeller.",
