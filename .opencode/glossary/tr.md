...
- PR #15835: https://github.com/anomalyco/kage/pull/15835

## Do Not Translate (Locale Additions)

- `KAGE` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `kage` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `KAGE` in prose, `kage` only for exact technical identifiers
...
- Avoid changing `kage` to `KAGE` inside commands, URLs, package names, or code literals
