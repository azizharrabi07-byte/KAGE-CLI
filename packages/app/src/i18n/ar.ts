export const dict = {
  ...
  "dialog.provider.kage.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.kage.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.kageGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من KAGE",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في KAGE.",
  ...
  "provider.connect.kageZen.line1":
    "يمنحك KAGE Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.kageZen.visit.prefix": "قم بزيارة ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في KAGE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في KAGE.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في kage.json",
  ...
  "dialog.server.description": "تبديل خادم KAGE الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من KAGE في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث KAGE في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث KAGE في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث KAGE",
  "wsl.onboarding.kageReadyIn": "KAGE جاهز في {{distro}}.",
  "wsl.onboarding.kageReady": "KAGE جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت KAGE في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت KAGE",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن KAGE من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على KAGE التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح KAGE.",
  ...
  "toast.update.description": "نسخة جديدة من KAGE ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق KAGE",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (kage.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن KAGE لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن KAGE نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم KAGE داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ KAGE",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور KAGE على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان KAGE يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة KAGE.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل KAGE",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من KAGE.",
