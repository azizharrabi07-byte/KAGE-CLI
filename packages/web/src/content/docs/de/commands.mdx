...
Erstellen Sie `.kage/commands/test.md`:

```md title=".kage/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die KAGE-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem KAGE [config](/docs/config):

```json title="kage.jsonc" {4-12}
{
...
- Global: `~/.config/kage/commands/`
- Pro Projekt: `.kage/commands/`

```markdown title="~/.config/kage/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".kage/commands/component.md"
---
...
```md title=".kage/commands/create-file.md"
---
...
```md title=".kage/commands/analyze-coverage.md"
---
...
```md title=".kage/commands/review-changes.md"
---
...
```md title=".kage/commands/review-component.md"
---
...
KAGE enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
