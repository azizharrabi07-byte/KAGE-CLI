...
import { Credential } from "@kage/schema/credential"
import { Integration } from "@kage/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@kage/v2/Credential") {}
