...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kage.git")).toEqual({ owner: "sst", repo: "kage" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kage")).toEqual({ owner: "sst", repo: "kage" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kage.git")).toEqual({ owner: "sst", repo: "kage" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kage")).toEqual({ owner: "sst", repo: "kage" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kage.git")).toEqual({ owner: "sst", repo: "kage" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kage")).toEqual({ owner: "sst", repo: "kage" })
})
