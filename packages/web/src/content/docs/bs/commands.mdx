...
Možete dodati prilagođene komande kroz KAGE konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom KAGE [config](/docs/config):
...
- Globalno: `~/.config/kage/commands/`
- Po projektu: `.kage/commands/`
...
KAGE uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
