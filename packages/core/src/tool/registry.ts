...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@kage/llm"
...
export class Service extends Context.Service<Service, Interface>()("@kage/v2/ToolRegistry") {}
