---
title: دعم ACP
description: استخدم KAGE في أي محرر متوافق مع ACP.
---

يدعم KAGE بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام KAGE عبر ACP، اضبط محررك ليشغّل الأمر `kage acp`.

يشغّل هذا الأمر KAGE كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'KAGE' من محدد الوكلاء في AI Chat.
...
لاستخدام KAGE كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام KAGE كوكيل ACP للدردشة.
...
يعمل KAGE عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات KAGE
