...
brew install anomalyco/tap/kage # macOS 和 Linux（推荐，始终保持最新）
brew install kage              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S kage            # Arch Linux (Stable)
paru -S kage-bin               # Arch Linux (Latest from AUR)
mise use -g kage               # 任意系统
nix run nixpkgs#kage           # 或用 github:anomalyco/kage 获取最新 dev 分支
```
...
KAGE 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/kage/releases) 或 [kage.ai/download](https://kage.ai/download) 下载。
...
了解更多 [Agents](https://kage.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://kage.ai/docs)。
...
如果你在项目名中使用了 “kage”（如 “kage-dashboard” 或 “kage-mobile”），请在 README 里注明该项目不是 KAGE 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=52ao9352-5623-4fa0-b7dd-3407c392c1af&qr_code=true) | [X.com](https://x.com/kage)
