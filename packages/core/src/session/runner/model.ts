...
import { type Model } from "@kage/llm"
import * as AnthropicMessages from "@kage/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@kage/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@kage/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@kage/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@kage/v2/SessionRunnerModel") {}
