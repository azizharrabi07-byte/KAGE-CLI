export const dict = {
  "app.title": "Rankingi użycia modeli AI | KAGE Data",
  "app.description":
    "Przeglądaj użycie KAGE Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny KAGE Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę KAGE na GitHub",
  "header.github": "GitHub",
  "header.tryKAGE": "Wypróbuj KAGE",
  ...
  "footer.homeAria": "Strona główna KAGE",
  ...
  "home.topModelsDescription": "Użycie modeli w KAGE Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy KAGE Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | KAGE Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w KAGE Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia KAGE.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w KAGE",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia KAGE",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów KAGE z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | KAGE Data",
  "model.description":
    "Zobacz dane użycia {{model}} w KAGE Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie KAGE Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu KAGE Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu KAGE Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia KAGE Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny KAGE Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia KAGE Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów KAGE Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy KAGE Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji KAGE Go.",
  ...
  "model.geoDescription": "Tokeny modelu KAGE Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne KAGE Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów KAGE Go.",
