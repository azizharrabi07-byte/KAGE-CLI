export const dict = {
  "app.title": "Ranking de uso de modelos de IA | KAGE Data",
  "app.description":
    "Explore o uso do KAGE Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do KAGE Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao KAGE no GitHub",
  "header.github": "GitHub",
  "header.tryKAGE": "Experimente o KAGE",
  ...
  "footer.homeAria": "Início do KAGE",
  ...
  "modal.title": "Newsletter do KAGE",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no KAGE Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do KAGE Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | KAGE Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no KAGE Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do KAGE.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no KAGE",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do KAGE",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do KAGE nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | KAGE Data",
  "model.description":
    "Veja dados de uso de {{model}} no KAGE Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no KAGE Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do KAGE Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do KAGE Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do KAGE Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do KAGE Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do KAGE Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do KAGE Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do KAGE Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do KAGE Go.",
  ...
  "model.geoDescription": "Tokens do modelo KAGE Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do KAGE Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do KAGE Go.",
