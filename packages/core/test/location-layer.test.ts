...
import { define } from "@kage/plugin/v2/effect"
...
import { LocationServiceMap } from "@kage/core/location-services"
      ...
      Effect.flatMap(([blocked, allowed]) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(() =>
            fs.writeFile(
              path.join(blocked.path, "kage.json"),
              JSON.stringify({
