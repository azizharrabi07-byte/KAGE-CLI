...
Generates UPCOMING_CHANGELOG.md by running the kage changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for kage run (default: low)
      --quiet            Suppress kage command output unless it fails
