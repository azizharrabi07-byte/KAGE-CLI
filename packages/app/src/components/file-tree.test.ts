...
beforeAll(async () => {
  ...
  mock.module("@kage/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@kage/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@kage/ui/icon", () => ({ Icon: () => null }))
  mock.module("@kage/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
