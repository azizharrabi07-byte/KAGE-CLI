...
import { Entry, FileSystem, FindInput, Match } from "@kage/schema/filesystem"
export { Entry, Match, Submatch } from "@kage/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@kage/v2/FileSystem") {}
