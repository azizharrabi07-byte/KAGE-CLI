---
title: LSP-servere
description: KAGE integreres med dine LSP-servere.
---

KAGE kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

KAGE leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og kage åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din kage-konfiguration.
