...
import { makeApi } from "@kage/protocol/api"
import { LocationMiddleware } from "@kage/server/location"
import { SessionLocationMiddleware } from "@kage/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("kage-root")
...
export const InstanceHttpApi = HttpApi.make("kage-instance")
...
export const KAGEHttpApi = HttpApi.make("kage")
