---
title: Teilen
description: Teile KAGE-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu KAGE-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht KAGE Folgendes:
...
KAGE hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt KAGE den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`kage.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du kage in deiner Organisation einsetzt.
