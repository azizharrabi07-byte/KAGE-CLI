---
title: Zen
description: Kuratierte Modellliste direkt von KAGE.
---
...
KAGE Zen ist eine Liste von getesteten und verifizierten Modellen, die vom KAGE-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in KAGE. Du meldest dich bei KAGE Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um KAGE zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit KAGE funktionieren.
:::
...
KAGE Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

KAGE Zen funktioniert wie jeder andere Provider in KAGE.

1. Du meldest dich bei **<a href={console}>KAGE Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst KAGE Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner KAGE-Konfiguration verwendet das Format `kage/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `kage/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. KAGE verwendet diese Modelle, um Session-Titel zu generieren.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf KAGE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf KAGE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf KAGE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf KAGE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf KAGE verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben KAGE Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit KAGE auch jeden anderen Provider zu verwenden.
