export const dict = {
  ...
  "dialog.provider.kage.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.kage.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.kageGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af KAGE",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i KAGE.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.kageZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kageZen.visit.prefix": "Besøg ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i KAGE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i KAGE.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i kage.json",
  ...
  "dialog.server.description": "Skift hvilken KAGE-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker KAGE i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer KAGE i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater KAGE i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater KAGE",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før KAGE kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "KAGE kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter KAGE igen.",
  ...
  "toast.update.description": "En ny version af KAGE ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til KAGE-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (kage.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, KAGE understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "KAGE inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør KAGE-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for KAGE",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan KAGE ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om KAGE følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan KAGE er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når KAGE starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af KAGE.",
