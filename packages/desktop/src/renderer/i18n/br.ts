export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do KAGE",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do KAGE foi baixada. Você gostaria de instalá-la e reiniciar?",
