...
import { Session } from "@kage-ai/sdk/v2/client"
...
import { toaster } from "@kage-ai/ui/toast"
...
import { retry } from "@kage-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@kage-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://kage.ai/desktop-feedback")}
      renderPanel={() =>
