...
export const TypeId: TypeId = "~@kage/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@kage/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@kage/effect-sqlite-node/NodeSqliteClient")
