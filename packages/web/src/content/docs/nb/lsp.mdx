---
title: LSP-servere
description: kage integreres med LSP-serverne dine.
---

KAGE kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

KAGE kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og kage åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i KAGE-konfigurasjonen.
