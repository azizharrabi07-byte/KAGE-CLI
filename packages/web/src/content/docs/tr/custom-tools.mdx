---
title: Özel Araçlar
description: LLM'un kage'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. kage'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.kage/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/kage/tools/` içine yerleştirerek.
