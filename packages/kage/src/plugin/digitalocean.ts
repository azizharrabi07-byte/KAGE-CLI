import type { Hooks, PluginInput } from "@kage/plugin"
import type { Model } from "@kage/sdk/v2"
import { InstallationVersion } from "@kage/core/installation/version"
import { OauthCallbackPage } from "@kage/core/oauth/page"
...
async function listRouters(
  ...
  const res = await fetch(`${DO_GENAI_API}/models/routers`, {
    headers: {
      ...
      "User-Agent": `kage/${InstallationVersion}`,
    },
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. KAGE will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
