...
import type { Plugin as PluginRuntime } from "@kage/plugin/v2/effect"
import { Plugin } from "@kage/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@kage/v2/Plugin") {}
