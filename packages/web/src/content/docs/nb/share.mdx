---
title: Deling
description: Del dine KAGE-samtaler.
---

Delingsfunksjonen i KAGE lar deg lage offentlige lenker til dine KAGE-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
KAGE støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker KAGE manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `kage.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av kage i organisasjonen din.
