...
- Effect plugins import `@kage-ai/plugin/v2/effect`, not `@kage-ai/core`.
- Public domain values use generated `@kage-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@kage-ai/plugin/v2/effect`.
