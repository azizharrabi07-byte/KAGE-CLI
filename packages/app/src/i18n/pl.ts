export const dict = {
  ...
  "dialog.provider.kage.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.kage.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.kageGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez KAGE",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w KAGE.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.kageZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.kageZen.visit.prefix": "Odwiedź ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w KAGE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w KAGE.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w kage.json",
  ...
  "dialog.server.description": "Przełącz serwer KAGE, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie KAGE w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie KAGE w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj KAGE w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj KAGE",
  "wsl.onboarding.kageReadyIn": "KAGE jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.kageReady": "KAGE jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj KAGE w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj KAGE",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim KAGE będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "KAGE nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz KAGE.",
  ...
  "toast.update.description": "Nowa wersja KAGE ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu KAGE",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (kage.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: KAGE nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "KAGE zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer KAGE wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla KAGE",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd KAGE na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy KAGE ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw KAGE.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania KAGE",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji KAGE.",
