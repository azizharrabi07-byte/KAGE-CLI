...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@kage/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@kage/ACPDirectory") {}
