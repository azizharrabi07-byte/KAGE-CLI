...
> current private `@kage-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@kage-ai/ai`
...
- Secondary audience: KAGE and other durable agent runtimes
...
import { LLM } from "@kage-ai/ai"
import { OpenAI } from "@kage-ai/ai/providers/openai"
...
```ts
import { Message } from "@kage-ai/ai"
...
import { LLM, Tool } from "@kage-ai/ai"
...
KAGE and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@kage-ai/ai/promise"
import { OpenAI } from "@kage-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@kage-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@kage-ai/ai/provider"
...
@kage-ai/ai/providers/openai
@kage-ai/ai/providers/anthropic
@kage-ai/ai/providers/google
...
```
...
KAGE should migrate to `generateTurn` / `streamTurn`, preserving its durable
