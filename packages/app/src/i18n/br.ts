export const dict = {
  ...
  "dialog.provider.kage.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.kage.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.kageGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo KAGE",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no KAGE.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.kageZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.kageZen.visit.prefix": "Visite ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no KAGE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no KAGE.",
  ...
  "dialog.plugins.empty": "Plugins configurados em kage.json",
  ...
  "dialog.server.description": "Trocar para qual servidor KAGE este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o KAGE em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o KAGE em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o KAGE em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o KAGE",
  "wsl.onboarding.kageReadyIn": "O KAGE está pronto em {{distro}}.",
  "wsl.onboarding.kageReady": "O KAGE está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o KAGE em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o KAGE",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o KAGE possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O KAGE não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o KAGE novamente.",
  ...
  "toast.update.description": "Uma nova versão do KAGE ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do KAGE",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (kage.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: KAGE ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "KAGE inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor KAGE dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do KAGE",
  ...
  "settings.general.row.appearance.description": "Personalize como o KAGE aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o KAGE segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o KAGE é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o KAGE iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do KAGE.",
