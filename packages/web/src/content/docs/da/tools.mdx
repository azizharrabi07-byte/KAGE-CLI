...
Her er alle de innebygde verktøyene som er tilgængelige i KAGE.
...
:::note
Dette verktøyet er bare tilgængelig når du bruger KAGE-leverandøren eller når miljøvariabelen `OPENCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
