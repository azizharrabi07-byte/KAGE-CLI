---
title: TUI
description: Korištenje korisničkog interfejsa KAGE terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KAGE pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje KAGE pokreće TUI za trenutni direktorij.
...
Kada koristite KAGE TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u KAGE. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz KAGE. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `kage.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo KAGE čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `kage.default`.
