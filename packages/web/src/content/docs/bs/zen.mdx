---
title: Zen
description: Kurirana lista modela koje nudi KAGE.
---
...
KAGE Zen je lista testiranih i provjerenih modela koje pruža KAGE tim.

Zen radi kao i svaki drugi provajder u KAGE. Prijavite se na KAGE Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili KAGE.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s KAGE.
:::
...
KAGE Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

KAGE Zen radi kao i svaki drugi provajder u KAGE.

1. Prijavite se na **<a href={console}>KAGE Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite KAGE Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj KAGE konfiguraciji koristi format
`kage/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `kage/gpt-5.5`.
...
U historiji korištenja možete primijetiti [jeftinije modele](/docs/config/#models), kao što su Haiku, Nano ili Flash. KAGE koristi ove modele za generisanje naslova sesija.
...
- DeepSeek V4 Flash Free je dostupan na KAGE ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na KAGE ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- North Mini Code Free je dostupan na KAGE ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na KAGE ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na KAGE ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u KAGE.
