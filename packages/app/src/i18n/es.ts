export const dict = {
  ...
  "dialog.provider.kage.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.kage.tagline": "Modelos optimizados y fiables",
  "dialog.provider.kageGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por KAGE",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en KAGE.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.kageZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.kageZen.visit.prefix": "Visita ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en KAGE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en KAGE.",
  ...
  "dialog.plugins.empty": "Plugins configurados en kage.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de KAGE se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando KAGE en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando KAGE en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza KAGE en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar KAGE",
  "wsl.onboarding.kageReadyIn": "KAGE está listo en {{distro}}.",
  "wsl.onboarding.kageReady": "KAGE está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala KAGE en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar KAGE",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que KAGE pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "KAGE no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir KAGE.",
  ...
  "toast.update.description": "Una nueva versión de KAGE ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de KAGE",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (kage.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, KAGE no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "KAGE incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor KAGE dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para KAGE",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve KAGE en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si KAGE sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de KAGE.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia KAGE",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de KAGE.",
