---
title: LSP Server
description: KAGE lässt sich in Ihren LSP-Server integrieren.
---

KAGE kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

KAGE verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und KAGE eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer KAGE-Konfiguration aktivieren und anpassen.
