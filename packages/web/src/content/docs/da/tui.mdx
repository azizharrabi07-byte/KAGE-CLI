---
title: TUI
description: Brug af KAGE-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KAGE giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre KAGE starter TUI for den nuværende mappe.
...
Når du bruger KAGE TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til KAGE. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `kage.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe KAGE venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `kage.default`.
