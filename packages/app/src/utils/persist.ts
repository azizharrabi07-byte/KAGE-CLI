...
import { checksum } from "@kage/core/util/encode"
...
const GLOBAL_STORAGE = "kage.global.dat"
const WINDOW_STORAGE = "kage.window"
const LOCAL_PREFIX = "kage."
...
function workspaceStorage(dir: string) {
  ...
  return `kage.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `kage.draft.${head}.${sum}.dat`
}
