export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | KAGE Data",
  "app.description":
    "Досліджуйте використання KAGE Go серед моделей ШІ, зокрема обсяг токенів, рейтинги, частку ринку, ціни токенів, вартість сеансу, частку кешу та географічні розрізи.",
  "app.unfurlAlt": "Словесний знак KAGE Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку KAGE на GitHub",
  "header.github": "GitHub",
  "header.tryKAGE": "Спробувати KAGE",
  ...
  "home.topModelsDescription": "Використання моделей в KAGE Go.",
  ...
  "home.uniqueUsersDescription": "Щоденні унікальні користувачі KAGE Go за моделлю.",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | KAGE Data",
  "lab.description":
    "Порівняйте моделі {{lab}}, які використовуються в KAGE Go, зокрема використання токенів, рейтинги моделей, контекстні вікна, дати релізів, вартість і дані конкретних моделей.",
  "lab.loadingTitle": "Лабораторія моделей",
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання KAGE.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в KAGE",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання KAGE",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів KAGE за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | KAGE Data",
  "model.description":
    "Перегляньте дані використання {{model}} в KAGE Go, зокрема обсяг токенів, тижневий ранг, мікс токенів, вартість, частку кешу, сеанси, географічні розрізи та схожі моделі.",
  ...
  "model.catalogFallback":
    "Факти моделі зі спільного індексу моделей. Використання KAGE Go з'явиться, коли ця модель матиме активність.",
  "model.unranked": "Без рейтингу у використанні KAGE Go за минулий тиждень",
  "model.ranked": "Ранг #{{rank}} у використанні KAGE Go за минулий тиждень",
  ...
  "model.noCurrentUsage": "Немає використання KAGE Go в поточному вікні даних.",
  ...
  "model.release": "Реліз",
  "model.inputs": "Входи",
  "model.overviewDescription": "Нещодавні токени KAGE Go, унікальні користувачі та ринкова позиція.",
  "model.noSummaryTitle": "Немає підсумку використання",
  "model.noSummaryDescription": "Ця модель ще не має рядків використання KAGE Go.",
  "model.tokens": "Токени",
  ...
  "model.usageDescription": "Щоденний обсяг токенів KAGE Go за нещодавнє двомісячне вікно.",
  ...
  "model.usersDescription": "Щоденні унікальні користувачі KAGE Go за нещодавнє двомісячне вікно.",
  ...
  "model.efficiencyDescription": "Вартість, поведінка кешу та середня форма сеансу KAGE Go.",
  ...
  "model.geoDescription": "Токени моделі KAGE Go, використані за країнами.",
  "model.noGeoTitle": "Немає геоданих",
  "model.noGeoDescription": "Жодні географічні рядки KAGE Go не відповідали цій моделі.",
  "model.worldMap": "Карта світу використання токенів моделі за країнами",
  "model.peersDescription": "Близькі моделі за нещодавнім обсягом токенів KAGE Go.",
