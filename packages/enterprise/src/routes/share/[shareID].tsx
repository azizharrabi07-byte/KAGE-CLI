import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@kage-ai/sdk/v2"
import { SessionTurn } from "@kage-ai/session-ui/session-turn"
import { SessionReview } from "@kage-ai/session-ui/session-review"
import { DataProvider } from "@kage-ai/session-ui/context"
import { FileComponentProvider } from "@kage-ai/ui/context/file"
import { WorkerPoolProvider } from "@kage-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@kage-ai/ui/logo"
import { IconButton } from "@kage-ai/ui/icon-button"
import { ProviderIcon } from "@kage-ai/ui/provider-icon"
import { iife } from "@kage-ai/core/util/iife"
import { Binary } from "@kage-ai/core/util/binary"
import { NamedError } from "@kage-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@kage-ai/ui/tabs"
import { MessageNav } from "@kage-ai/session-ui/message-nav"
import { FileSSR } from "@kage-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@kage-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/kage-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | KAGE</Title>
              </Show>
              <Meta name="description" content="kage - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/kage"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
