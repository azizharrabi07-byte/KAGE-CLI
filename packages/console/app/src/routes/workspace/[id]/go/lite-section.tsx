...
import { Billing } from "@kage-ai/console-core/billing.js"
import { Database, eq, and, isNull } from "@kage-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@kage-ai/console-core/schema/billing.sql.js"
import { WorkspaceTable } from "@kage-ai/console-core/schema/workspace.sql.js"
import { Actor } from "@kage-ai/console-core/actor.js"
import { Workspace } from "@kage-ai/console-core/workspace.js"
import { Subscription } from "@kage-ai/console-core/subscription.js"
import { LiteData } from "@kage-ai/console-core/lite.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#kage-go")} target="_blank" rel="noopener noreferrer">
