...
import compareVideo from "../../asset/lander/kage-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/kage-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="kage:auth" content={loggedin() ? "true" : "false"} />
