export const dict = {
  ...
  "dialog.provider.kage.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.kage.tagline": "Reliable optimized models",
  "dialog.provider.kageGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by KAGE",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in KAGE.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.kageZen.line1":
    "KAGE Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.kageZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.kageZen.visit.prefix": "Visit ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in KAGE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in KAGE.",
  ...
  "dialog.plugins.empty": "Plugins configured in kage.json",
  ...
  "dialog.server.description": "Switch which KAGE server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "Checking KAGE in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "Updating KAGE in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update KAGE in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update KAGE",
  "wsl.onboarding.kageReadyIn": "KAGE is ready in {{distro}}.",
  "wsl.onboarding.kageReady": "KAGE is ready.",
  "wsl.onboarding.installOpencodeIn": "Install KAGE in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install KAGE",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before KAGE can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "KAGE could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen KAGE.",
  ...
  "toast.update.description": "A new version of KAGE ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the KAGE team",
  ...
  "error.chain.checkConfig": "Check your config (kage.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, KAGE does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "KAGE includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the KAGE server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for KAGE",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how KAGE looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether KAGE follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how KAGE is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when KAGE launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of KAGE.",
