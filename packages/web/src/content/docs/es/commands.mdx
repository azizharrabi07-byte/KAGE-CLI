...
Puede agregar comandos personalizados a través de la configuración KAGE o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su KAGE [config](/docs/config):
...
kage incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
