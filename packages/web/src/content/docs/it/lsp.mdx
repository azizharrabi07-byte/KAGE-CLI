---
title: Server LSP
description: KAGE si integra con i tuoi server LSP.
---

KAGE può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

KAGE include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e kage apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di kage.
