---
title: LSP Servers
description: KAGE integrates with your LSP servers.
---

KAGE can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

KAGE comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and kage opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your kage config.
