export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de KAGE",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de KAGE. ¿Quieres instalarla y reiniciar?",
