---
title: TUI
description: استخدام واجهة المستخدم TUI في KAGE.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر KAGE واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل KAGE إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة KAGE في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى KAGE. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من KAGE. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `kage.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار KAGE بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `kage.default`.
