---
title: Zen
description: Udvalgt liste over modeller leveret af KAGE.
---
...
KAGE Zen er en liste over testede og verificerede modeller leveret af KAGE-teamet.

Zen fungerer som enhver anden udbyder i KAGE. Du logger ind på KAGE Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med KAGE.
:::
...
KAGE Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

KAGE Zen fungerer som enhver anden udbyder i KAGE.

1. Du logger ind på **<a href={console}>KAGE Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger KAGE Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din KAGE-konfiguration
bruger formatet `kage/<model-id>`. For eksempel ville du for GPT 5.5
bruge `kage/gpt-5.5` i din konfiguration.
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. KAGE bruger disse modeller til at generere sessionstitler.
...
- DeepSeek V4 Flash Free er tilgængelig på KAGE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på KAGE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på KAGE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på KAGE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på KAGE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med KAGE også.
