---
title: Share
description: Share your KAGE conversations.
---

KAGE's share feature allows you to create public links to your KAGE conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, KAGE:
...
KAGE supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, KAGE uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `kage.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using kage in your organization.
