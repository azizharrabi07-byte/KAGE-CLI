...
brew install anomalyco/tap/kage # macOS og Linux (anbefalt, alltid oppdatert)
brew install kage              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
KAGE er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/anomalyco/kage/releases) eller [kage.ai/download](https://kage.ai/download).
...
KAGE har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://kage.ai/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer KAGE, [**se dokumentasjonen**](https://kage.ai/docs).

### Bidra

Hvis du vil bidra til KAGE, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på KAGE

Hvis du jobber med et prosjekt som er relatert til KAGE og bruker "kage" som en del av navnet; for eksempel "kage-dashboard" eller "kage-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av KAGE-teamet og ikke er tilknyttet oss på noen måte.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/kage) | [X.com](https://x.com/kage)
