export const dict = {
  ...
  "dialog.provider.kage.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.kage.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.kageGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "KAGEが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、KAGEで{{provider}}モデルを使用します。",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.kageZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.kageZen.visit.prefix": " ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してKAGEで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、KAGEで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "kage.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するKAGEサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "KAGEを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のKAGEを確認中...",
  "wsl.onboarding.updatingOpencode": "KAGEを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のKAGEを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のKAGEを更新してください。",
  "wsl.onboarding.updateOpencode": "KAGEを更新",
  "wsl.onboarding.kageReadyIn": "{{distro}}内のKAGEの準備ができました。",
  "wsl.onboarding.kageReady": "KAGEの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にKAGEをインストールしてください。",
  "wsl.onboarding.installOpencode": "KAGEをインストール",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGEがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KAGEでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、KAGEをもう一度開いてください。",
  ...
  "toast.update.description": "KAGEの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKAGEチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (kage.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: KAGEはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "KAGEには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKAGEサーバーを実行します。",
  ...
  "settings.general.row.language.description": "KAGEの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのKAGEの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "KAGEがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "KAGEのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "KAGE の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "KAGE は最新バージョンです。",
