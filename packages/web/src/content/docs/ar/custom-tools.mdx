...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في kage.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في kage مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.kage/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/kage/tools/`.
