...
import { buildPrompt } from "@kage/core/session/compaction"
import { SessionCompactionEvent } from "@kage/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@kage/SessionCompaction") {}
