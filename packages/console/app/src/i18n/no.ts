...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | kage",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "kage logo lys",
  "notFound.logoDarkAlt": "kage logo mørk",
  ...
  "app.meta.description": "KAGE - Den åpne kildekode kodingsagenten.",

  "home.title": "KAGE | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "kage | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av kage",
  ...
  "temp.screenshot.caption": "kage TUI med tokyonight-tema",
  "temp.screenshot.alt": "kage TUI med tokyonight-tema",
  "temp.logoLightAlt": "kage logo lys",
  "temp.logoDarkAlt": "kage logo mørk",
  ...
  "home.what.title": "Hva er KAGE?",
  "home.what.body": "KAGE er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes KAGE av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "KAGE lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er KAGE?",
  "home.faq.a1":
    "KAGE er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg KAGE?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke KAGE?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. KAGE kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men KAGE fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med KAGE?",
  "home.faq.a4.p1":
    "Ja, KAGE støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke KAGE i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! KAGE er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster KAGE?",
  "home.faq.a6":
    "KAGE er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er KAGE åpen kildekode?",
  "home.faq.a8.p1": "Ja, KAGE er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som KAGE har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "KAGE Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som KAGE har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er KAGE Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak KAGE.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan KAGE forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger KAGE til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med KAGE, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare KAGE-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med KAGE, kan du bruke Zen med hvilken som helst agent.",
  ...
  "go.title": "KAGE Go | Rimelige kodemodeller for alle",
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe KAGE-opplevelsen til så mange som mulig. KAGE Go er et rimelig abonnement: $5 for den første måneden, deretter $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter på $5 for den første måneden, deretter $10/måned. Du kan bruke det med KAGE eller hvilken som helst agent.",
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampanjen for {{model}} er avsluttet. Du kan fortsette å bruke modellen ved å abonnere på KAGE Go - {{link}}",

  "black.meta.title": "KAGE Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med KAGE Black-abonnementer.",
  "black.hero.title": "Få tilgang til verdens beste kodemodeller",
  "black.hero.subtitle": "Inkludert Claude, GPT, Gemini og mer",
  "black.title": "KAGE Black | Priser",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for KAGE Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med kage når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg kage",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start kage og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til kage-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en kage Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på KAGE Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for KAGE Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på KAGE Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.message": "Du abonnerer på KAGE Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "KAGE Go" som leverandør i kage-konfigurasjonen din for å bruke Go-modeller.',
  ...
  "workspace.lite.black.message":
    "Du abonnerer for øyeblikket på KAGE Black eller står på venteliste. Vennligst avslutt abonnementet først hvis du vil bytte til Go.",
  "workspace.lite.other.message":
    "Et annet medlem i dette arbeidsområdet abonnerer allerede på KAGE Go. Kun ett medlem per arbeidsområde kan abonnere.",
  "workspace.lite.promo.description":
    "KAGE Go starter på {{price}}, deretter $10/måned, og gir pålitelig tilgang til populære åpne kodingsmodeller med sjenerøse bruksgrenser.",
  ...
  "download.title": "KAGE | Last ned",
  "download.meta.description": "Last ned KAGE for macOS, Windows og Linux",
  "download.hero.title": "Last ned KAGE Desktop",
  ...
  "download.section.integrations": "KAGE Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble KAGE til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer KAGE med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "KAGE er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om KAGE fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i KAGE.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "KAGE | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt KAGE for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "KAGE opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er KAGE Enterprise?",
  "enterprise.faq.a1":
    "KAGE Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med KAGE Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. KAGE lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med KAGE Enterprise?",
  "enterprise.faq.a4":
    "Ja. KAGE lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "KAGE | Merkevare",
  "brand.meta.description": "KAGE retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med KAGE-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "KAGE | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for KAGE",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for KAGE",
