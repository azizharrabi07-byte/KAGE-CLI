...
<p align="center">KAGE — the AI Operating System.</p>
<p align="center">
...
```bash
# YOLO
curl -fsSL https://github.com/azizharrabi07-byte/KAGE-CLI/install | bash
...
```bash
# Examples
OPENCODE_INSTALL_DIR=/usr/local/bin curl -fsSL https://github.com/azizharrabi07-byte/KAGE-CLI/install | bash
XDG_BIN_DIR=$HOME/.local/bin curl -fsSL https://github.com/azizharrabi07-byte/KAGE-CLI/install | bash
```
...
Learn more about [agents](https://github.com/azizharrabi07-byte/KAGE-CLI/docs/agents).
