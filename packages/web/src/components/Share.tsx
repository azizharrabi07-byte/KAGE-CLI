...
import type { MessageV2 } from "kage/session/message-v2"
import type { Message } from "kage/session/message"
import type { Session } from "kage/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.kage_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.kage_name}>
