...
Możesz zdefiniować polecenia w `kage.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji kage:
...
- Globalnie: `~/.config/kage/commands/`
- Na projekt: `.kage/commands/`
...
kage zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
