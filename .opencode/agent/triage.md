...
Desktop application and browser-based app issues, including `kage web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core kage server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

KAGE Zen, KAGE Go, and billing issues.
