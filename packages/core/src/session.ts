...
import { ListAnchor } from "@kage/schema/session"
...
import { SessionDurable } from "@kage/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@kage/v2/Session") {}
