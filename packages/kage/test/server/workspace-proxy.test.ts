...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips kage-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-kage-directory"]).toBeUndefined()
      expect(forwarded["x-kage-workspace"]).toBeUndefined()
