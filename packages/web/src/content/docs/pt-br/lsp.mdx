...
description: O kage integra-se aos seus servidores LSP.
---

O kage pode se integrar a servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para o agente.

---

## Integrados

O kage vem com vários servidores LSP integrados para linguagens populares:
...
Quando o LSP está habilitado e o kage abre um arquivo, ele:
...
Você pode habilitar e personalizar os servidores LSP através da seção `lsp` na sua configuração do kage.
