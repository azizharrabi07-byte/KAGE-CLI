...
description: kage dile özgü biçimlendiriciler kullanır.
---

kage, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

kage, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, kage bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

kage bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri kage yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
