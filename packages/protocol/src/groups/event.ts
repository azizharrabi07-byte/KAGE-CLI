...
import type { Definition } from "@kage/schema/event"
...
export const KAGEEvent = event.schema
export type KAGEEvent = typeof KAGEEvent.Type
export type KAGEEventEncoded = typeof KAGEEvent.Encoded
