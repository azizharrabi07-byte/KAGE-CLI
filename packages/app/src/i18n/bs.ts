export const dict = {
  ...
  "dialog.provider.kage.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.kage.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.kageGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje KAGE",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u KAGE-u.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.kageZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.kageZen.visit.prefix": "Posjeti ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u KAGE-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u KAGE-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u kage.json",
  ...
  "dialog.server.description": "Promijeni na koji se KAGE server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera KAGE u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje KAGE u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj KAGE u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj KAGE",
  "wsl.onboarding.kageReadyIn": "KAGE je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.kageReady": "KAGE je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj KAGE u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj KAGE",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi KAGE mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "KAGE nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori KAGE.",
  ...
  "toast.update.description": "Nova verzija KAGE-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku KAGE timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (kage.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: KAGE još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "KAGE uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni KAGE server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u KAGE-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako KAGE izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li KAGE prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu KAGE-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se KAGE pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju KAGE-a.",
