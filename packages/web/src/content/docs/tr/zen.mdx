---
title: Zen
description: kage tarafından sağlanan seçilmiş modeller listesi.
---
...
KAGE Zen, KAGE ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, KAGE'daki diğer sağlayıcılar gibi çalışır. KAGE Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve KAGE kullanmak için buna ihtiyacınız yoktur.
...
:::tip
KAGE ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
KAGE Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

KAGE Zen, KAGE'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>KAGE Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, KAGE Zen'i seçin ve API anahtarınızı yapıştırın.
...
KAGE yapılandırmanızdaki [model id](/docs/config/#models) `kage/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `kage/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. KAGE, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için KAGE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için KAGE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için KAGE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için KAGE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için KAGE'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
KAGE Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca KAGE ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
