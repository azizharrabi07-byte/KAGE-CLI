export const dict = {
  ...
  "dialog.provider.kage.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.kage.tagline": "Modèles optimisés et fiables",
  "dialog.provider.kageGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par KAGE",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans KAGE.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.kageZen.visit.prefix": "Visitez ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans KAGE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans KAGE.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans kage.json",
  ...
  "dialog.server.description": "Changez le serveur KAGE auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'KAGE dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'KAGE dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour KAGE dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour KAGE",
  "wsl.onboarding.kageReadyIn": "KAGE est prêt dans {{distro}}.",
  "wsl.onboarding.kageReady": "KAGE est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez KAGE dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer KAGE",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'KAGE puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "KAGE n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez KAGE.",
  ...
  "toast.update.description":
    "Une nouvelle version d'KAGE ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe KAGE",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (kage.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'KAGE ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "KAGE inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur KAGE dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour KAGE",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'KAGE sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si KAGE suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'KAGE.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'KAGE",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'KAGE.",
