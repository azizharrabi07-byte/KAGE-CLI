import type { JsonSchema, LLMRequest, ProviderMetadata } from "@kage/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@kage/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @kage/llm request objects from kage's session/AI SDK-shaped data.
  return LLM.request({
