...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/kage/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/kage...\n")
...
console.log("Fetching npm all-time downloads for kage-ai...\n")
const npmDownloads = await fetchNpmDownloads("kage-ai")
