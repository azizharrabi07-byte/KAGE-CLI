...
export const dict = {
  ...
  "dialog.provider.kage.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.kage.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.kageGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von KAGE",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in KAGE zu nutzen.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.kageZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.kageZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in KAGE zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in KAGE zu nutzen.",
  ...
  "dialog.plugins.empty": "In kage.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den KAGE-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "KAGE wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "KAGE in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "KAGE wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "KAGE in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie KAGE in {{distro}}.",
  "wsl.onboarding.updateOpencode": "KAGE aktualisieren",
  "wsl.onboarding.kageReadyIn": "KAGE ist in {{distro}} bereit.",
  "wsl.onboarding.kageReady": "KAGE ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie KAGE in {{distro}}.",
  "wsl.onboarding.installOpencode": "KAGE installieren",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor KAGE einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "KAGE konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann KAGE erneut.",
  ...
  "toast.update.description": "Eine neue Version von KAGE ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem KAGE-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (kage.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: KAGE unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "KAGE enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "KAGE-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für KAGE ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie KAGE auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob KAGE dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von KAGE anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von KAGE automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von KAGE.",
