...
export const dict = {
  ...
  "dialog.provider.kage.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.kage.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.kageGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av KAGE",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i KAGE.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.kageZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kageZen.visit.prefix": "Besøk ",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i KAGE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i KAGE.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i kage.json",
  ...
  "dialog.server.description": "Bytt hvilken KAGE-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av KAGE ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til KAGE-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (kage.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at KAGE ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "KAGE inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør KAGE-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for KAGE",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan KAGE ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om KAGE skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan KAGE er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når KAGE starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av KAGE.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker KAGE...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker KAGE i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer KAGE...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer KAGE i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater KAGE i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater KAGE",
  "wsl.onboarding.kageReadyIn": "KAGE er klar i {{distro}}.",
  "wsl.onboarding.kageReady": "KAGE er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer KAGE i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før KAGE kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "KAGE kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter KAGE på nytt.",
