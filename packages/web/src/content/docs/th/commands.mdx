...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ KAGE:
...
- ระดับผู้ใช้ (Global): `~/.config/kage/commands/`
- ระดับโปรเจ็กต์: `.kage/commands/`
...
KAGE มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
