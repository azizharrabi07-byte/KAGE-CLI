...
import { EventSequenceTable, EventTable } from "@kage/core/event/sql"
...
import { WorkspaceEvent } from "@kage/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@kage/Workspace") {}
