---
title: Zen
description: Utvalgt liste over modeller levert av KAGE.
---
...
KAGE Zen er en liste over testede og verifiserte modeller levert av KAGE-teamet.

Zen fungerer som enhver annen leverandør i KAGE. Du logger inn på KAGE Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med KAGE.
:::
...
KAGE Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

KAGE Zen fungerer som enhver annen leverandør i KAGE.

1. Du logger inn på **<a href={console}>KAGE Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger KAGE Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i KAGE-konfigurasjonen din
bruker formatet `kage/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `kage/gpt-5.5` i konfigurasjonen din.
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. KAGE bruker disse modellene til å generere økttitler.
...
- DeepSeek V4 Flash Free er tilgjengelig på KAGE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på KAGE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på KAGE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på KAGE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på KAGE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med KAGE også.
