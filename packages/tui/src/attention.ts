...
import defaultSoundPath from "@kage/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@kage/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@kage/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@kage/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@kage/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@kage/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "kage"
const DEFAULT_PACK_ID = "kage.default"
