...
Use this folder for locale-specific translation guidance that supplements `.kage/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/kage/pull/12345

## Do Not Translate (Locale Additions)

- `KAGE` (preserve casing)
