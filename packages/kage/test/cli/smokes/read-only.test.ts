...
describe("kage read-only commands (smoke)", () => {
  ...
  cliIt.live(
    ...
    ({ kage }) =>
      Effect.gen(function* () {
        const r = yield* kage.spawn(["mcp", "list"])
        kage.expectExit(r, 0, "mcp list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ kage }) =>
      Effect.gen(function* () {
        const r = yield* kage.spawn(["providers", "list"])
        kage.expectExit(r, 0, "providers list")
  ...
  cliIt.live(
    ...
    ({ kage }) =>
      Effect.gen(function* () {
        const r = yield* kage.spawn(["models"])
        kage.expectExit(r, 0, "models")
  ...
  cliIt.live(
    ...
    ({ kage }) =>
      Effect.gen(function* () {
        const r = yield* kage.spawn(["agent", "list"])
        kage.expectExit(r, 0, "agent list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ kage }) =>
      Effect.gen(function* () {
        const r = yield* kage.spawn(["session", "list"])
        kage.expectExit(r, 0, "session list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ kage }) =>
      Effect.gen(function* () {
        const r = yield* kage.spawn(["stats"])
        kage.expectExit(r, 0, "stats")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ kage }) =>
      Effect.gen(function* () {
        const r = yield* kage.spawn(["db", "path"])
        kage.expectExit(r, 0, "db path")
