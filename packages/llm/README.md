...
Schema-first LLM core for kage. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@kage-ai/llm"
import { OpenAI } from "@kage-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@kage-ai/llm/providers"
