...
import type { Data, Definition, Payload } from "@kage/schema/event"
...
import { Durable } from "@kage/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@kage/schema/event").ID
export type { Data, Definition, Payload } from "@kage/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@kage/Event") {}
