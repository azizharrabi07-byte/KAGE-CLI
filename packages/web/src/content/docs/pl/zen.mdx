---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez KAGE.
---
...
KAGE Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół KAGE.

Zen działa jak każdy inny dostawca w KAGE. Logujesz się do KAGE Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z KAGE.
:::
...
KAGE Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

KAGE Zen działa jak każdy inny dostawca w KAGE.

1. Logujesz się do **<a href={console}>KAGE Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz KAGE Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji KAGE używa formatu
`kage/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`kage/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. KAGE używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w KAGE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w KAGE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w KAGE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w KAGE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w KAGE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w KAGE także dowolnego innego dostawcy.
