// Shared type vocabulary for the direct interactive mode (`kage --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@kage/sdk/v2"
