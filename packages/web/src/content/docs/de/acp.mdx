...
description: Verwenden Sie KAGE in jedem ACP-kompatiblen Editor.
---

KAGE unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um KAGE über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `kage acp`.

Der Befehl startet KAGE als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „KAGE“ in der AI Chat Agent Selector.
...
Um KAGE als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass KAGE als ACP-Agent für den Chat verwendet wird.
...
KAGE funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer KAGE-Konfiguration konfiguriert sind
