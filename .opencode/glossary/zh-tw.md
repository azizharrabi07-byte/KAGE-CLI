...
- PR #13942: https://github.com/anomalyco/kage/pull/13942

## Do Not Translate (Locale Additions)

- `KAGE` (preserve casing in prose; keep `kage` only when it is part of commands, package names, paths, or code)
- `KAGE Zen`
- `KAGE CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `kage` in prose when referring to the product name; use `KAGE`
