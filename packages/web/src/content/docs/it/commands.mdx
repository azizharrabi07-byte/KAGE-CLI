...
Puoi aggiungere comandi personalizzati tramite la config di KAGE o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di KAGE:
...
- Globale: `~/.config/kage/commands/`
- Per progetto: `.kage/commands/`
...
kage include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
