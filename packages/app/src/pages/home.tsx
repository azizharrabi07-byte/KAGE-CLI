import type { Session } from "@kage-ai/sdk/v2/client"
import {
  type ComponentProps,
  createEffect,
  createMemo,
...
import { Logo } from "@kage-ai/ui/logo"
import { Spinner } from "@kage-ai/ui/spinner"
import { ScrollView } from "@kage-ai/ui/scroll-view"
import { ProjectAvatar } from "@kage-ai/ui/v2/project-avatar-v2"
...
import { useMarked } from "@kage-ai/ui/context/marked"
import { preloadMarkdown } from "@kage-ai/session-ui/markdown-cache"
      ...
      >
        <div class="mx-auto grid min-h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
          <HomeProjectColumn
            ...
            openHelp={() => platform.openLink("https://kage.ai/desktop-feedback")}
            language={language}
            onWheel={(event) => {
