...
Agentferdigheter lar KAGE oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går kage opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
kage viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `kage.json`:
