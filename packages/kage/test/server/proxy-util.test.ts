...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips kage-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-kage-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-kage-directory")).toBeNull()
      expect(result.get("x-kage-workspace")).toBeNull()
