...
const en = {
  "app.title": "AI Model Usage Rankings | KAGE Data",
  "app.description":
    "Explore KAGE Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "KAGE Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star KAGE on GitHub",
  "header.github": "GitHub",
  "header.tryKAGE": "Try KAGE",
  ...
  "home.topModelsDescription": "Usage of models across KAGE Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique KAGE Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | KAGE Data",
  "lab.description":
    "Compare {{lab}} models used in KAGE Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent KAGE usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in KAGE",
  ...
  "lab.shareOfUsage": "{{share}} of recent KAGE usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | KAGE Data",
  "model.description":
    "View {{model}} KAGE Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. KAGE Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's KAGE Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's KAGE Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No KAGE Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no KAGE Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "KAGE Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No KAGE Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent KAGE Go token volume.",
