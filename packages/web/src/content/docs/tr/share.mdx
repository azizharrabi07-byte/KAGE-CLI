---
title: Paylasim
description: kage konusmalarini genel baglantilarla paylasin.
---

kage'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda kage:
...
kage, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak kage manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `kage.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda kage kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
