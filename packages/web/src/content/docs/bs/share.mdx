---
title: Dijeljenje
description: Dijelite KAGE razgovore javnim linkovima.
---

KAGE opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
KAGE podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, KAGE koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `kage.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju kage u organizaciji.
