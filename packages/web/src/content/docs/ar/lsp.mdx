---
title: خوادم LSP
description: يتكامل KAGE مع خوادم LSP لديك.
---

يمكن أن يتكامل KAGE مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي KAGE مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح kage لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات kage.
