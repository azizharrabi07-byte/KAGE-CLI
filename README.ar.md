<p align="center">
  <a href="https://kage.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="شعار KAGE">
    </picture>
  </a>
</p>
...
# مديري الحزم
npm i -g kage-ai@latest        # او bun/pnpm/yarn
scoop install kage             # Windows
choco install kage             # Windows
brew install anomalyco/tap/kage # macOS و Linux (موصى به، دائما محدث)
brew install kage              # macOS و Linux (صيغة brew الرسمية، تحديث اقل)
sudo pacman -S kage            # Arch Linux (Stable)
paru -S kage-bin               # Arch Linux (Latest from AUR)
mise use -g kage               # اي نظام
nix run nixpkgs#kage           # او github:anomalyco/kage لاحدث فرع dev
```
...
يتوفر KAGE ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/kage/releases) او من [kage.ai/download](https://kage.ai/download).
...
4. `$HOME/.kage/bin` - المسار الافتراضي الاحتياطي
...
يتضمن KAGE وكيليْن (Agents) مدمجين يمكنك التبديل بينهما باستخدام زر `Tab`.
...
تعرف على المزيد حول [agents](https://kage.ai/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط KAGE، [**راجع التوثيق**](https://kage.ai/docs).

### المساهمة

اذا كنت مهتما بالمساهمة في KAGE، يرجى قراءة [contributing docs](./CONTRIBUTING.md) قبل ارسال pull request.

### البناء فوق KAGE

اذا كنت تعمل على مشروع مرتبط بـ KAGE ويستخدم "kage" كجزء من اسمه (مثل "kage-dashboard" او "kage-mobile")، يرجى اضافة ملاحظة في README توضح انه ليس مبنيا بواسطة فريق KAGE ولا يرتبط بنا بأي شكل.

---

**انضم الى مجتمعنا** [Discord](https://discord.gg/kage) | [X.com](https://x.com/kage)
