...
export const dict = {
  ...
  "dialog.provider.kage.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.kage.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.kageGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "KAGE tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve KAGE'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.kageZen.line1":
    "KAGE Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.kageZen.visit.prefix": "",
  "provider.connect.kageZen.visit.link": "kage.ai/zen",
  "provider.connect.kageZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak KAGE'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak KAGE'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler kage.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi KAGE sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "KAGE kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde KAGE kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "KAGE güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde KAGE güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki KAGE'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "KAGE'u güncelle",
  "wsl.onboarding.kageReadyIn": "{{distro}} içinde KAGE hazır.",
  "wsl.onboarding.kageReady": "KAGE hazır.",
  "wsl.onboarding.installOpencodeIn": "KAGE'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "KAGE'u kur",
  ...
  "wsl.onboarding.distroStatus.kageMissing": "KAGE kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KAGE'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "KAGE bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından KAGE'u tekrar açın.",
  ...
  "toast.update.description": "KAGE'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı KAGE ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (kage.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: KAGE henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "KAGE ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "KAGE Masaüstü",
  ...
  "settings.desktop.wsl.description": "KAGE sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "KAGE'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "KAGE'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "KAGE'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "KAGE'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "KAGE başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "KAGE'un en son sürümünü kullanıyorsunuz.",
