---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala kage.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

kage zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie kage uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI kage, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do kage. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `kage.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo KAGE czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `kage.default`.
